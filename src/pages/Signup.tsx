    ...
    <div className='flex items-center justify-center w-screen h-screen bg-cover bg-center bg-no-repeat bg-background-1' >
      <div className='flex bg-white flex-col w-auto items-center justify-center p-8 rounded-xl' >
        ...
        <form className='flex flex-col mx-auto w-96 mt-8 '>
          ...
          <h1 className='font-bold text-center text-2xl text-title'>Cadastro</h1>

          <input className='px-3 py-2 placeholder-gray-400 border-[#E8E8E8] border rounded-md focus:outline-none focus:border-blue focus:ring-blue mt-2' type="email" placeholder='Nome' />
          ...
          <input className='px-3 py-2 placeholder-gray-400 border-[#E8E8E8] border rounded-md focus:outline-none focus:border-blue focus:ring-blue mt-2' type="email" placeholder='Confirmar senha' />
            <button
              type='submit'
          ...
          <a className='text-center text-sm font-medium mt-16 text-title' href="logout">Já tem uma conta? Fazer login</a>
